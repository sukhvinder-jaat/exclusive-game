...
const AccordionComponent = () => {
  ...
  return (
    <div className=" relative" id="faq">
      ...
      <div className="container max-w-[1152px] mx-auto px-3 md:mb-[150px] mb-20">
        <h2 className="font-anton md:text-5xl text-3xl text-center font-normal text-white leading-[112%]">
        ...
        <div className="max-w-[970px] mx-auto">
          {accordianData.map((value, index) => (
            <Accordion
              key={index}
              className="flex flex-col justify-between border-[0.5px] border-[#80898D] rounded-md px-6 bg-transparent overflow-hidden ease-out transition-all duration-300 mt-10 relative"
