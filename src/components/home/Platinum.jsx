...
const Platinum = () => {
  return (
    <div className=" md:pb-36 pb-32 relative">
      ...
      <div className=" container xl:max-w-[1140px] px-3 mx-auto">
        <div className="border border-[rgba(255,_255,_255,_0.5)] Nuestras-ofertas-box mt-7 lg:mt-[60px] rounded-md px-5 py-10 lg:py-[78px] lg:px-12">
          <div className="flex flex-wrap lg:flex-row flex-col-reverse justify-between items-center">
