  ...
  return (
    <div className=" bg-white">
      <div className=" container xl:max-w-[1140px] px-3 mx-auto">
        <h2 className=" font-anton text-3xl md:text-5xl text-darkBlue text-center md:mb-14 mb-10">
        ...
        <div className=" flex md:flex-row flex-col md:gap-0 gap-5 items-center justify-between mb-[150px] relative">
          <div className="absolute  lg:flex hidden w-full xl:max-w-[276px] max-w-[150px] start-[19%] top-0 ">
            <TopArrow />
          </div>
